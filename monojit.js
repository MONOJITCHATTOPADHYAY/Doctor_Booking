...
if (feeFilter === "under800") {
    finalList = finalList.filter(d => d.fee < 800);
}
else if (feeFilter === "800to1500") {
    finalList = finalList.filter(d => d.fee >= 800 && d.fee <= 1500);
}
else if (feeFilter === "above1500") {
    finalList = finalList.filter(d => d.fee > 1500);
}
